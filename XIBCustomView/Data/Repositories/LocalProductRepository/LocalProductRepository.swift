...
class LocalProductRepository: LocalProductRepositoryProtocol {
    ...
    func getProductLocally(
        ...
        Error
    > {
        coreDataStorageManager.getProduct(
            response: product
        )
    }
    ...
    func addNewProductLocally(
        ...
        Error
    > {
        coreDataStorageManager.addNewProduct(
            response: product
        )
    }
    ...
    func updateProductLocally(
        ...
        Error
    > {
        coreDataStorageManager.updateProduct(
            response: product
        )
    }
    ...
    func deleteProductLocally(
        ...
        Error
    > {
        coreDataStorageManager.deleteProduct(
            response: product
        )
    }
    ...
    func saveProductsFromJSON(
        ...
        coreDataStorageManager.saveProductsFromJSON(
            response: product
        )
    }
}
